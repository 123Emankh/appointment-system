...
public class InMemoryRepository {
    ...
    private Schedule schedule; // إضافة Schedule
    ...
    public InMemoryRepository() {
        ...
        this.schedule = new Schedule(); // تهيئة Schedule
    ...
    public void saveAppointment(Appointment appointment) {
        ...
        schedule.addAppointment(appointment); // إضافة إلى Schedule أيضاً
    }

    // دالة جديدة لـ addAppointment
    ...
    public void removeAppointment(String id) {
        ...
        // يمكن إزالته من Schedule أيضاً إذا لزم
    }
