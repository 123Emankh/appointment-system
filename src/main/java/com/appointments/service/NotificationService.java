...
public class NotificationService {
    ...
    // تغيير هنا: قبول NotificationMessage بدلاً من String
    public void notifyObservers(User user, NotificationMessage message) {
        String messageText = message.getContent(); // استخراج النص من الكائن
    ...
    // يمكنك إضافة دالة مساعدة للتوافق مع الكود القديم إذا أردت
